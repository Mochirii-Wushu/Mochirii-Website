...
const checks = [
  ...
  ["test:facebook-page-publishing", ["deno", "test", "--node-modules-dir=auto", "--import-map=supabase/functions/publish-facebook-page-gallery-submission/deno.json", "--lock=deno.lock", "--frozen=true", "supabase/functions/_shared/facebook-page-publishing_test.ts", "supabase/functions/_shared/facebook-page-queue-pagination_test.ts"]],
  ...
  ["test:social-publication-copy", ["node", "--experimental-default-type=module", "--experimental-strip-types", "--test", "apps/web/lib/gallery/social-publication-copy_test.ts"]],
