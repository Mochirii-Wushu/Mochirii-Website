...
const checks = [
  ...
  ["check:paid-recruitment-home", ["node", "scripts/check-paid-recruitment-home.mjs"]],
  ...
  ["test:paid-recruitment-tracking", ["node", "--experimental-default-type=module", "--experimental-strip-types", "--test", "apps/web/lib/paid-recruitment-tracking.test.mts"]],
