...
const checkRows = [
  ...
  ["check:app-route-evidence", ["node", "scripts/check-app-route-evidence.mjs"]],
  ["test:app-route-evidence", ["node", "--test", "scripts/lib/app-route-evidence.test.mjs"]],
  ...
  ["test:social-oauth-consent", ["node", "--experimental-default-type=module", "--experimental-strip-types", "--test", "apps/web/lib/oauth/approved-social-redirect.test.mts", "apps/web/lib/oauth/authorization-decision-core.test.mts", "apps/web/lib/oauth/authorization-load-queue.test.mts", "apps/web/lib/oauth/consent-login-url.test.mts", "apps/web/lib/oauth/prior-consent-redirect.test.mts", "apps/web/lib/supabase/profile-verification-time.test.mts", "apps/web/lib/supabase/social-service-entitlement.test.mts", "scripts/lib/runtime-diagnostic-redaction.test.mjs"]],
  ...
  ["test:spotlight-content", ["node", "--experimental-strip-types", "--test", "apps/web/components/public-pages/spotlight-content.test.mts"]],
  ["test:spotlight-response", ["node", "--experimental-strip-types", "--test", "apps/web/lib/supabase/spotlight-response.test.mts"]],
  ["test:spotlight-winner-handler", ["deno", "test", "--allow-env", "--node-modules-dir=auto", "--import-map=supabase/functions/get-current-spotlight-winner/deno.json", "--lock=deno.lock", "--frozen=true", "supabase/functions/get-current-spotlight-winner/index_test.ts"]],
  ["check:spotlight-selection", ["node", "scripts/check-spotlight-selection.mjs"]],
