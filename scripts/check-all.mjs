...
const checks = [
  ...
  ["test:discord-gallery-authorization-context", ["deno", "test", "--lock=deno.lock", "--frozen=true", "supabase/functions/_shared/discord-gallery-authorization-context_test.ts"]],
  ["test:discord-gallery-ingest-payload", ["deno", "test", "--lock=deno.lock", "--frozen=true", "supabase/functions/_shared/discord-gallery-ingest-payload_test.ts"]],
  ["test:discord-gallery-storage-reservation", ["deno", "test", "--lock=deno.lock", "--frozen=true", "supabase/functions/_shared/discord-gallery-storage-reservation_test.ts"]],
  ["test:discord-gallery-ingest-transport", ["deno", "test", "--lock=deno.lock", "--frozen=true", "supabase/functions/_shared/gallery-discord-ingest_test.ts"]],
