...
const checks = [
  ...
  ["test:raffle-disabled-foundation", ["deno", "test", "--node-modules-dir=none", "--config=supabase/functions/manage-raffle-claim/deno.json", "--lock=supabase/functions/manage-raffle-claim/deno.lock", "--frozen=true", "supabase/functions/_shared/raffle-claim-boundary_test.ts", "supabase/functions/_shared/raffle-claim_test.ts", "supabase/functions/_shared/raffle-flags_test.ts", "supabase/functions/_shared/raffle-fulfillment_test.ts", "supabase/functions/_shared/reward-crypto_test.ts", "supabase/functions/_shared/reward-provider-webhook_test.ts"]],
