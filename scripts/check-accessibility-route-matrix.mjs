...
const routes = [
  ...
  { route: "/raffle", label: "Raffle", file: "apps/web/app/raffle/page.tsx", type: "public", workflow: "monthly raffle program, drawing status, and standing, current, and archived rules", componentFiles: ["apps/web/components/public-pages/route-pages/RafflePage.tsx"] },
  ...
  { route: "/privacy", label: "Privacy", file: "apps/web/app/privacy/page.tsx", type: "public", workflow: "website privacy information and request contact" },
  { route: "/meta-data-deletion", label: "Data Deletion Requests", file: "apps/web/app/meta-data-deletion/page.tsx", type: "public", workflow: "scoped website data-deletion request instructions" },
