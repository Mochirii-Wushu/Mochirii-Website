...
select ok(
  ...
  'anon and authenticated cannot execute any of the 22 service RPCs'
);
...
select ok(
  ...
  'PUBLIC has no execute ACL on any of the 22 service RPC overloads'
);
...
select lives_ok(
  $$insert into public.raffle_cycles (
      ...
      'test-v1', '/raffle/rules/test-v1', 1000, 5000,
...
select lives_ok(
  $$insert into public.raffle_cycles (
      ...
      'test-v1', '/raffle/rules/test-v1', 2500, 5000,
...
select lives_ok(
  $$insert into public.raffle_cycles (
      ...
      'test-v1', '/raffle/rules/test-v1', 5000, 5000,
...
select throws_like(
  $$insert into public.raffle_cycles (
      ...
      '2026-08-18 00:00:00+00', 'test-v1', '/raffle/rules/test-v1',
      900, 5000,
...
insert into public.raffle_cycles (
  ...
  'test-v1', '/raffle/rules/test-v1', repeat('a', 64),
...
insert into public.raffle_cycles (
  ...
  'test-v1', '/raffle/rules/test-v1', repeat('1', 64),
...
insert into public.raffle_entries (
  ...
  ('60000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000900', '20000000-0000-4000-8000-000000000001', 'eligible', 'eligible', 'US', true, '2026-07-02 00:00:00+00', 5, 'test-v1', 'test-v1', 'active', true, 'cleared', '2026-07-02 00:00:00+00', '20000000-0000-4000-8000-000000000001', 'administrator_household_cleared'),
  ('60000000-0000-4000-8000-000000000002', '10000000-0000-4000-8000-000000000900', '20000000-0000-4000-8000-000000000002', 'eligible', 'eligible', 'US', true, '2026-07-02 00:00:00+00', 5, 'test-v1', 'test-v1', 'active', true, 'cleared', '2026-07-02 00:00:00+00', '20000000-0000-4000-8000-000000000001', 'administrator_household_cleared'),
  ('60000000-0000-4000-8000-000000000003', '10000000-0000-4000-8000-000000000900', '20000000-0000-4000-8000-000000000003', 'eligible', 'eligible', 'US', true, '2026-07-02 00:00:00+00', 5, 'test-v1', 'test-v1', 'active', true, 'cleared', '2026-07-02 00:00:00+00', '20000000-0000-4000-8000-000000000001', 'administrator_household_cleared');
...
insert into public.raffle_cycles (
  ...
  'test-v1', '/raffle/rules/test-v1', repeat('6', 64),
