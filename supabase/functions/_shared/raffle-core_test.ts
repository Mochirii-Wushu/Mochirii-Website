...
Deno.test("entry calculation gives five base and at most five unique free bonuses", () => {
  const completions = [
    ...
    { bonusKey: "member_kudos", completionMethod: "primary", revoked: true },
    { bonusKey: "unknown", completionMethod: "primary" },
  ];

  assert(
    completedBonusKeys(completions).length === 5,
