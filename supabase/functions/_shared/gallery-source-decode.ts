...
export function gallerySourcePreviewResponse(
  ...
  return new Response(body, {
    ...
    headers: {
      ...
      "X-Gallery-Submission-Id": metadata.submissionId,
      "X-Gallery-Source-Width": String(metadata.width),
      "X-Gallery-Source-Height": String(metadata.height),
      "X-Gallery-Source-Validated-At": metadata.validatedAt,
