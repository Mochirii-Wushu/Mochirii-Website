...
Deno.test("public cycle conforms to the provider-neutral 5 plus 5 contract", () => {
  const cycle = {
    ...
    max_bonus_entries: 5,
    max_entries: 10,
    rules_version_url: "/raffle/rules/monthly-2026-08",
  ...
  assert(
    view.baseEntries === 5 && view.maximumBonusEntries === 5 &&
      view.maximumEntries === 10,
    "public entry limits drifted from 5 plus 5",
  );
  assert(
