...
export function loadConfig(env = process.env, options = {}) {
  ...
  return Object.freeze({
    ...
    inboundRequestTimeoutMs: integer(env.REWARD_RELAY_INBOUND_REQUEST_TIMEOUT_MS, 10_000, 10_000, 10_000, "REWARD_RELAY_INBOUND_REQUEST_TIMEOUT_MS"),
    headersTimeoutMs: integer(env.REWARD_RELAY_HEADERS_TIMEOUT_MS, 5_000, 5_000, 5_000, "REWARD_RELAY_HEADERS_TIMEOUT_MS"),
    keepAliveTimeoutMs: integer(env.REWARD_RELAY_KEEP_ALIVE_TIMEOUT_MS, 5_000, 5_000, 5_000, "REWARD_RELAY_KEEP_ALIVE_TIMEOUT_MS"),
