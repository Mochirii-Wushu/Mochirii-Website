...
Route::domain(config('pixelfed.domain.app'))->middleware(['validemail', 'twofactor', 'localization'])->group(function () {
    ...
    Route::group(['prefix' => 'site'], function () {
        ...
        Route::group(['prefix' => 'kb'], function () {
            ...
            Route::get('instance-actor', fn () => abort(404))->name('help.instance-actor');
            ...
            Route::redirect('what-is-the-fediverse', '/site/help')->name('help.what-is-fediverse');
            ...
            Route::get('labs-deprecation', fn () => abort(404))->name('help.labs-deprecation');
            ...
            Route::get('account-migration', fn () => abort(404))->name('help.account-migration');
        });
